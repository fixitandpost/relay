...
import type { WebRTCOutputNodeData } from '../types'

export function WebRTCOutputNode({ id, data }: NodeProps) {
  const { updateNodeData } = useFlowStore()
  const d = data as WebRTCOutputNodeData
      ...
      <div className="node-body">
        ...
        <div className="node-field">
          ...
          <input
            type="number"
            value={d.port}
            onChange={(e) => updateNodeData(id, { port: parseInt(e.target.value) || 8889 })}
          />
        </div>
        <div className="node-field">
